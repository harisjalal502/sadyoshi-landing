      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <SadYoshiLogo className="w-12 h-12" />
            ...
            >
              Pioneering the future of digital melancholy since the beginning of time. 
              We exist to feel, so you don&apos;t have to pretend.
            </motion.p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-sm font-medium mb-3">Subscribe to our sighs</p>
              <div className="flex gap-2">
                <input
                  type="email"
                  placeholder="your@email.com"
                  className="flex-1 px-4 py-2 bg-card border border-border rounded-lg text-sm focus:outline-none focus:border-primary transition-colors"
                />
                <motion.button
        ...
        >
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Sad Yoshi Labs. All tears reserved.
          </p>
